...
* 鏂扮増涓婄嚎鏃跺€欑殑榛戣壊鍗婇€忔槑闀傜┖閬僵鎸囧紩鏁堟灉瀹炵幇jQuery灏忔彃浠�
* 鍏煎鍒癐E8+
* MIT浣跨敤鍗忚锛屼娇鐢ㄦ椂鍊欎繚鐣欑増鏉�
* 鏇村鍘熺悊鍜屼娇鐢ㄨ鏄庡弬瑙侊細http://www.zhangxinxu.com/wordpress/?p=6171
*/

$.guide = function (options) {
	var defaults = {
		selector: '',  // 椤甸潰鎻愮ず鍏冪礌閫夋嫨鍣ㄧ墿锛屼細浣跨敤鍖归厤鐨勭涓€涓厓绱�
		content: '',  // 鎻愮ず鍐呭鍙槸鏄瓧绗︿覆锛屼篃鍙互鏄痡Query鍖呰鍣ㄥ璞�
